...
class WebServicesFacturacion {
  ...
  public $log = 'WebServicesFacturacion-log.txt';
  public $debug;
  public $url; 
  public $soap;
  ...
  */
    ...
    try {
      ...
      $this->soap = "SOAP request:\t".$cliente->__getLastRequest()."SOAP response:\t".$cliente->__getLastResponse();
      return true; 
