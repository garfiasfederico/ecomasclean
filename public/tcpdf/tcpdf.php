...
class TCPDF {
	...
	public function Footer() {
		...
		if (empty($this->pagegroups)) {
			$pagenumtxt = "Fecha de Impresión: ".date("d/m/Y H:i:s")."                                                                                                                                                                     ".$w_page.$this->getAliasNumPage().' / '.$this->getAliasNbPages();
		} else { 
			$pagenumtxt = "Fecha de Impresión: ".date("d/m/Y H:i:s")."                                                                                                                                                                     ". $w_page.$this->getPageNumGroupAlias().' / '.$this->getPageGroupAlias();
		}
