 ...
 * Header title.
 */
define ('PDF_HEADER_TITLE', 'Jefatura de la Gubernatura');

/**
 * Header description string.
 */
define ('PDF_HEADER_STRING', "Ficha Técnica de Programas, Proyectos y Acciones (PPA) realizadas como respuesta a la Emergencia Sanitaria a causa del COVID 2019");
